  ...
  public ChatAdapter(ArrayList<BaseModel>baseModelList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull  ViewGroup parent, int viewType) {
        ...
        return new SenderViewHolder(view);
            case 1:
                View view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.recever_item_layout,parent,false);
                return new ReceveViewHolder(view1);
        }
        return null;
    }
...
switch (viewType){
    ...
    case 1:
        if (holder instanceof ReceveViewHolder){
            ReceverModel receverModel = (ReceverModel)baseModelList.get(position);
            ((ReceveViewHolder) holder).setData(receverModel);
        }
}
    }
